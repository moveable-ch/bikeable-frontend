<template>
  <div class="date-range-picker">
    ...
    <button class="reset" @click="reset" v-if="datePickerData.startDate">
      <svg
  ...
  methods: {
    daysOfWeek() {
      ...
      for (var i = 0; i < 7; i++) {
        ...
        result.push(
          d.toLocaleDateString(this.$i18n.locale, { weekday: "short" })
        );
      }
      return result;
    },
    months() {
      ...
      for (var i = 0; i < 12; i++) {
        ...
        result.push(
          d.toLocaleDateString(this.$i18n.locale, { month: "short" })
        );
      }
      return result;
    },
